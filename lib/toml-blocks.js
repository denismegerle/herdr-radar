...
// below — a bracket, `#`, `=`, `.`, a backslash or a newline — becomes `_`.
// The quotes themselves stay, so a quoted key is still a quoted key and a
// header still ends on the bracket it should. One pass over characters, not
// lines: TOML strings do not respect lines, and a scanner that tracked
// them per line (with regexes, at that) was shown five different ways to
// mistake a string for a table. Each string form and its own ending:
//
//   """ … """   a backslash escapes the next character; may span lines
//   " … "       likewise, on one line
//   ''' … '''   nothing escapes; may span lines
//   ' … '       likewise, on one line
